...
sc = pickle.load(open('D:\OPEN SOURCE\Crop Recommendation\crop-prediction-backend\models\standscaler.pkl', 'rb'))
ms = pickle.load(open('D:\OPEN SOURCE\Crop Recommendation\crop-prediction-backend\models\minmaxscaler.pkl', 'rb'))
